...
// جلب الحسابات ليعرف المستخدم أي حساب سيشحن
try {
    $stmt = $pdo->prepare("SELECT account_id, currency, balance FROM accounts WHERE user_id = UNHEX(REPLACE(?, '-', ''))");
...
<div class="container">
    <h2 style="text-align: center; margin-bottom: 30px;">إيداع أموال في حسابك</h2>

    <a href="virtual_bank_gateway.php" class="method-card">
        <div class="icon-box"><i class="fa-solid fa-building-columns"></i></div>
        <div class="method-info">
            <div class="method-title">البنك الافتراضي (بوابة آمنة) <span class="badge-recommended">آلي وفوري</span></div>
            <div class="method-desc">استخدم أي بطاقة بنكية (تجريبية) لشحن حسابك فوراً.</div>
        </div>
        <i class="fa-solid fa-chevron-left"></i>
    </a>

    <div class="method-card" onclick="alert('يرجى تصوير شاشة الحوالة وإرسالها لوتساب الدعم: 77xxxxxxx')">
        ...
        <div class="method-info">
            ...
            <div class="method-desc">إيداع يدوي عبر شبكات الصرافة المحلية.</div>
        </div>
        <i class="fa-solid fa-chevron-left"></i>
    </div>

    <p style="text-align: center; color: #94a3b8; font-size: 13px; margin-top: 20px;">
        <i class="fa-solid fa-shield-halved"></i> بوابة شحن مشفرة بمعايير بنكية.
    </p>
</div>
