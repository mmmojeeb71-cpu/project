...
try {
    ...
    // 2. إدخال بيانات البطاقة الظاهرة في صورتك
    try {
        // نستخدم REPLACE لضمان تحديث الرصيد إذا كانت البطاقة موجودة مسبقاً
        ...
        echo "✅ **برافو! تمت إضافة بطاقتك الحقيقية بنجاح.**<br>";
        echo "🔹 الرقم: <b>$real_card_num</b> | CVV: <b>$real_cvv</b> | الرصيد: <b>$real_balance USD</b><br>";
    } catch (Exception $e) {
        echo "❌ خطأ في إضافة البطاقة: " . $e->getMessage() . "<br>";
    }

    echo "<br>🚀 <b>مبروك! تم تحديث النظام وإضافة ميزات البنك المحاكي والبطاقة المتعددة وحالة التجميد ونظام API المتقدم، وتم تفعيل بطاقتك الشخصية بنجاح.</b>";
